class MakeWidgetAndManufaturers < ActiveRecord::Migration[6.0]
  def change
    ...
    create_table :manufacturers, comment: 'Makers of the widgets we sell' do |t|
      ...
      t.references :address, null: false, foreign_key: true, comment: 'The address of this manufacturer'
      t.timestamps null: false
    end
    ...
    create_table :widgets, comment: 'The stuff we sell' do |t|
      ...
      t.references :widget_status, null: false, foreign_key: true, comment: 'The current status of this widget'
      t.references :manufacturer, null: false, foreign_key: true, comment: 'The maker of this widget'
      t.timestamps null: false
    end
